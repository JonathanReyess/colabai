...
You should include a new line after you return the course name with the description.
...
if prompt := st.chat_input(placeholder="Try 'Are there any classes about Python programming?' "):
